...
<nav id="menu">
	<ul>
		<li>
            <a href="index.php?pag=quienes" alt="#">¿QUIÉNES SOMOS?</a>
        </li>
        <li>
            <a href="index.php?pag=quehacemos" alt="#">¿QUÉ HACEMOS?</a>
        </li>
      
        <li>
            <a href="index.php?pag=proyectos" alt="#">PROYECTOS</a>
        </li>
        <li>
            <a href="index.php?pag=publicacion" alt="#">PUBLICACIONES</a>
        </li>
        <li>
            <a href="index.php?pag=noticias" id="menuFix"alt="#">NOTICIAS Y EVENTOS</a>
        </li>
        <li>
            <a href="index.php?pag=contactos" alt="#">CONTÁCTENOS</a>
        </li>
	</ul>
</nav>
